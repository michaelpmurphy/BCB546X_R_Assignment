...
###MPMURPHY COMMENTS > Ugh, I placed the source files in a data folder in my project directory... and then forgot to add the data folder to my git repository. Very frustrating oversight!
